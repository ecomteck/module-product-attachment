...
namespace Ecomteck\ProductAttachment\Block\Adminhtml\ProductAttachment;

/**
 * Class Grid
 * @package Ecomteck\ProductAttachment\Block\Adminhtml\ProductAttachment
 */
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
     ...
     * @param \Ecomteck\ProductAttachment\Model\ProductAttachment $productattach
    ...
    public function __construct(
        ...
        \Ecomteck\ProductAttachment\Model\ProductAttachment $productattach,
    ...
    public function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                'header' => __('File'),
                'index' => 'file',
                'renderer' => 'Ecomteck\ProductAttachment\Block\Adminhtml\ProductAttachment\Renderer\FileIcon'
            ]
        );
        ...
        $this->addColumn(
            ...
            [
                ...
                'renderer' => 'Ecomteck\ProductAttachment\Block\Adminhtml\ProductAttachment\Renderer\Group'
            ]
        );
        ...
        $this->addColumn(
            ...
            [
                'header' => __('Store '),
                'index' => 'store',
                'renderer' => 'Ecomteck\ProductAttachment\Block\Adminhtml\ProductAttachment\Renderer\Store'
            ]
        );
        ...
        $this->addColumn(
            ...
            [
                'header' => __('Active'),
                'index' => 'active',
                'renderer' => 'Ecomteck\ProductAttachment\Block\Adminhtml\ProductAttachment\Renderer\Active'
            ]
        );
