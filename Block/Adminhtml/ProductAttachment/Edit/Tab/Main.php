...
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    public function _prepareForm()
    {
        ...
        $form->setHtmlIdPrefix('productattachment_main_');
        ...
        $fieldset->addField(
            ...
            [
                ...
                'title' => __('File'),
                'required' => false,
                'note' => 'File size must be less than 5 Mb.', // TODO: show ACCTUAL file-size
                'disabled' => $isElementDisabled
            ]
        );
        ...
        $fieldset->addType(
            'uploadedfile',
            \Ecomteck\ProductAttachment\Block\Adminhtml\ProductAttachment\Renderer\FileIconAdmin::class
        );
        ...
        $fieldset->addField(
            ...
            [
                'name' => 'visible-scope',
                'label' => __('Visible to people who have not purchased this item'),
                'title' => __('Visible to people who have not purchased this item'),
                'value' => 0,
        ...
        $this->_eventManager->dispatch('adminhtml_productattachment_edit_tab_main_prepare_form', ['form' => $form]);
