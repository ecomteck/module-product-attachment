...
class ProductAttachmentTable extends
    \Magento\Framework\Model\AbstractModel implements
    \Ecomteck\ProductAttachment\Api\Data\ProductAttachmentTableInterface,
    \Magento\Framework\DataObject\IdentityInterface
{
    const CACHE_TAG = 'ecomteck_productattachment_productattachmenttable';
    protected $_cacheTag = 'ecomteck_productattachment_productattachmenttable';
    protected $_eventPrefix = 'ecomteck_productattachment_productattachmenttable';

    protected function _construct()
    {
        $this->_init('Ecomteck\ProductAttachment\Model\ResourceModel\ProductAttachment');
    }
